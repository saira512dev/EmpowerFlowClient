    ...
    <div className="flex items-center justify-between bg-white px-4 py-3 dark:bg-black dark:px-4 dark:py-3"> 
        ...
        <div className="flex items-center gap-8">
            <div className="relative flex h-min w-[200px]">
                <Search className="absolute left-[4px] top-1/2 h-5 w-5 -translate-y-1/2 transform cursor-point
                dark:text-white"/>
        ...
        <div className="flex items-center">
            ...
            <div className="ml-2 mr-5 hidden min-h-[2em] w-[0.1rem] bg-fray-200 md:inline-block">
